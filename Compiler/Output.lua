...
__bundle_register("Modules/Helpers/Pascal", function(require, _LOADED, __bundle_register, __bundle_modules)
	...
	function Pascal:GetBuilderSettingFromIdentifier(Identifier)
		return Helper.LoopLuaTable(
			Pascal:GetConfig().AutoParryBuilder.BuilderSettingsList,
...
__bundle_register("Features/AutoParry", function(require, _LOADED, __bundle_register, __bundle_modules)
	...
	function AutoParry.CheckFacingThresholdOnPlayers(LocalPlayerData, HumanoidRootPart)
		...
		print(LocalToTargetResult, TargetToLocalResult)
	...
	function AutoParry.ValidateState(AnimationTrack, BuilderData, LocalPlayerData, HumanoidRootPart, Player, AfterDelay)
		-- Only do this if there is a valid player...
		if Player and HumanoidRootPart and LocalPlayerData.HumanoidRootPart then
	...
	function AutoParry.DelayAndValidateStateFn(
		...
		if
			not AutoParry.ValidateState(AnimationTrack, BuilderData, LocalPlayerData, HumanoidRootPart, Player, false)
		then
			return false
		end
		...
		if
			not AutoParry.ValidateState(AnimationTrack, BuilderData, LocalPlayerData, HumanoidRootPart, Player, true)
		then
			return false
		end
...
__bundle_register("UI/Tabs/CombatTab", function(require, _LOADED, __bundle_register, __bundle_modules)
	...
	function CombatTab:LoadDefaultConfig()
		...
		local JSONData =
			readfile(Pascal:GetConfigurationPath() .. "/CombatConfigurations/" .. ConfigToAutoload .. ".json")
		if not JSONData then
			return
		end
...
__bundle_register("UI/Library/Library", function(require, _LOADED, __bundle_register, __bundle_modules)
	...
	function Library:AddAnimationDataToInfoLogger(
		DataName,
		AnimationId,
		AnimationName,
		AnimationTrack,
